...
namespace ProjectsTool.Controllers
{
    public class DegreesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Course,School,Level")] Degree degree)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Course,School,Level")] Degree degree)
        {
            if (ModelState.IsValid)
            {
